...
{
    public class DevHandInputSource : MonoBehaviour, IHandInputSource
    {
        [Title("Input Asset")]
        ...
        private void BindActions()
        {
            ...
            {
                Debug.LogError("DevHandInputSource [ERROR] >> No InputActionAsset assigned.");
                return;
            }
            ...
            if (actionMap == null)
            {
                Debug.LogError($"DevHandInputSource [ERROR] >> No action map found named '{actionMapName}'.");
                return;
            }
        ...
        {
            if (action == null)
                Debug.LogWarning($"DevHandInputSource [WARNING] >> Missing action '{actionName}'.");
        }
    }
}